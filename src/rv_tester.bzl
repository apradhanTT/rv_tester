...
load("@rv_tester//src/cosim:cosim.bzl", "cosim_gen")
load("@rv_tester//src/sysmod:sysmod.bzl", "sysmod_gen")
load("@rv_tester//src/pmu:pmu.bzl", "pmu_gen")
load("@rv_tester//src/pmu:pmu_fragment_gen.bzl", "pmu_fragment_gen")
load("@rv_tester//src/interrupts:interrupts.bzl", "interrupts_gen")
load("@rv_tester//src/memdump:memdump.bzl", "memdump_gen")
load("@rv_tester//src/triggers:triggers.bzl", "triggers_gen")
load("@rv_tester//src/transactors/axi_sw:axi_sw.bzl", "axi_sw_gen", "generate_axi_interfaces")
load("@rv_tester//scripts/csr:csr_param_gen.bzl", "csr_param_gen")
load("@rv_tester//src/cosim:project_overrides_gen.bzl", "project_overrides_gen")
...
def rv_tester_gen(
    ...
    **kwargs
    ...
    packet_gen(
        ...
        srcs = [
            name + "_pmu_fragments/gen_events.yaml",
            "@rv_tester//src:rv_tester_transactions.yml",
        ],
    ...
    verilog_library(
        name = name + "_harness",
        srcs = [
            "@rv_tester//src:rv_tester_pkg.sv",
            "@rv_tester//src:rv_tester_defines.sv",
        ],
        deps = [
            topology + "_sv",
    ...
    native.cc_library(
        name = rv_tester_dpi,
        srcs = ["@rv_tester//src:rv_tester.cpp"],
        deps = [
